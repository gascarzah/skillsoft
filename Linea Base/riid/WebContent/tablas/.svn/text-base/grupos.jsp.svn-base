...
function ordena(ord){
	if(ord=="cod") location.href="../servlet/CtrlMant?opt=17&ORDEN=t.cgrupo"; 
	if(ord=="des") location.href="../servlet/CtrlMant?opt=17&ORDEN=t.dgrupo"; 
	if(ord=="est") location.href="../servlet/CtrlMant?opt=17&ORDEN=t.bestadoreg"; 
}
...
<table align="center" width="100%">
  ...
  <tr>
    <td colspan="3" align="center" class="titulo1">MANTENIMIENTO DE LA TABLA DE GRUPOS</td>
  </tr>
</table>
			...
			<td>
				<table width="100%" border="1" align="center" cellspacing="0" bordercolor="#DFE6EE" bgcolor="#FFFFFF">
					<tr bgcolor="#3DB7E4" class="Estilo3" align="center">
					  ...
					  <td rowspan="2"><a href="javascript:ordena('est');" class="a" title="Ordenar por este campo">ESTADO</a></td>
					</tr>
					<tr bgcolor="#3DB7E4" class="Estilo3" align="center">
			...
			<td>
				<table width="100%" border="1" align="center"  cellspacing="0" bordercolor="#DFE6EE" bgcolor="#FFFFFF">
					<tr class="Estilo3"  bgcolor="#3DB7E4" align="center">
					  <td colspan="2"><center>NUEVO GRUPO</center></td>
					...
					<tr align="center">
						<td colspan="3" bgcolor="#3DB7E4">
							<input type="hidden" name="pg" value="<%= objLst.getPag()%>">
							<input type="hidden" name="opt" value="18">
