...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ProductAdapter.ViewHolder holder, int position) {
        ...
        if(product.getDiscount()!=0){
            Double discountPercent =  productService.getPercentDiscount(product.getDiscount());
            Double discountPrice = productService.getDiscountPrice(product.getDiscount(),product.getPrice());
            Integer discountPercentInteger = discountPercent.intValue();
            holder.discountTextView.setText("-" + discountPercentInteger.toString() + "%");
