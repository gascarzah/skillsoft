...
function getReg(cod,des,est){ 
	...
	eval('document.f.ESTADO.readOnly=true');
	document.f.ESTADO.style.backgroundColor="#DFE6EE";
}
...
function getSalir(){
	...
	if (caso == 'CANCELAR'){
		...
		eval('document.f.ESTADO.readOnly=false');
		document.f.ESTADO.style.backgroundColor="#FFFFFF";
		inicio();
	}
	else{
...
function getGrabar(){
	if (document.f.ESTADO.value == "" || document.f.DESCRIPCION.value == "" || document.f.BESTADOREG.value == ""){
...
<table align="center" width="100%">
  ...
  <tr>
    <td colspan="3" align="center" class="titulo1">MANTENIMIENTO DE LA TABLA ESTADO SITUACIONAL</td>
  </tr>
</table>
<form name="f1" method="post">
	...
	%>
					<tr bgcolor="<%=bFil?"#EAEFF5":"#FFFFFF"%>" class="celdas01">
					  <td align="center">
						<% if (clusuario.getPerfil().compareTo("09")==0 || clusuario.getPerfil().compareTo("00")==0){ %>
              <a href="javascript:getReg('<%=v.get(0)%>','<%=v.get(1)%>','<%=v.get(2)%>');">
		...
		<tr>
			<td>
				<table width="100%" border="1" align="center"  cellspacing="0" bordercolor="#DFE6EE" bgcolor="#FFFFFF">
					...
					<tr align="center">
						<td><input name="ESTADO" type="text" class="celdas01" onfocus="nextfield ='DESCRIPCION';" onchange="veridigitos(this);" size="11" maxlength="11"></td>
						<td><input name="DESCRIPCION" type="text" class="celdas01" onfocus="nextfield ='BESTADOREG';" onchange="cambia(this);" size="50" maxlength="15"></td>
						<td>
					...
					<tr align="center" bgcolor="#3DB7E4">
						<td colspan="3">
