...
<table align="center" width="100%">
  ...
  <tr>
    <td colspan="3" align="center" class="titulo1">MANTENIMIENTO DE LA TABLA DE MODALIDAD DE CONCLUSIONES</td>
  </tr>
</table>
			...
			<td>
				<table width="100%" border="1" align="center" cellspacing="0" bordercolor="#DFE6EE" bgcolor="#FFFFFF">
					<tr bgcolor="#3DB7E4" class="Estilo3" align="center">
					  <td >ITEM</td>
					  <td>CODIGO</td>
					  <td>MODALIDAD DE CONCLUSIONES</td>
					  <td >ESTADO</td>
					</tr>
			...
			<td>
				<table width="100%" border="1" align="center"  cellspacing="0" bordercolor="#DFE6EE" bgcolor="#FFFFFF">
					<tr class="Estilo3"  bgcolor="#3DB7E4" align="center">
					  <td colspan="2"><center>NUEVA MODALIDAD DE CONCLUSIONES</center></td>
					...
					<tr align="center">
						<td colspan="3" bgcolor="#3DB7E4">
							<input type="hidden" name="pg" value="<%= objLst.getPag()%>"/>
							<input type="hidden" name="opt" value="39"/>
