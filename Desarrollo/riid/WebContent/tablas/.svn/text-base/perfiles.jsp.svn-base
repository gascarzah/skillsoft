...
function ordena(ord){
	if(ord=="cod") location.href="../servlet/CtrlMant?opt=22&ORDEN=t.cperfil"; 
	if(ord=="des") location.href="../servlet/CtrlMant?opt=22&ORDEN=t.dperfil"; 
	if(ord=="est") location.href="../servlet/CtrlMant?opt=22&ORDEN=t.bestadoreg"; 
}
...
<table align="center" width="100%">
  ...
  <tr>
    <td colspan="3" align="center" class="titulo1">MANTENIMIENTO DE LA TABLA DE PERFILES DE USUARIO</td>
  </tr>
</table>
