...
<table align="center" width="100%">
  ...
  <tr>
    <td colspan="3" align="center" class="titulo1">MANTENIMIENTO DE LA TABLA TIPOS DE SOLICITUD EN FICHA</td>
  </tr>
</table>
<form name="f1" method="post">
	...
	%>
					<tr bgcolor="<%=bFil?"#EAEFF5":"#FFFFFF"%>" class="celdas01">
					  <td align="center"><% if (clusuario.getPerfil().compareTo("09")==0 || clusuario.getPerfil().compareTo("00")==0){ %>
...
<%
	if (objLst!=null) {
		if (clusuario.getPerfil().equals("00")){
%>
