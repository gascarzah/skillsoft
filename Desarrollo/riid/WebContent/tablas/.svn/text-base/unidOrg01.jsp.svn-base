...
<table align="center" width="100%">
  ...
  <tr>
    <td colspan="3" align="center" class="titulo1">MANTENIMIENTO DE LA TABLA DE UNIDADES ORGANICAS NIVEL 01</td>
  </tr>
</table>
<form name="f1" method="post">
	<table width="800" border="0" align="center" cellspacing="0">
		<tr class="celdas01">
			<td>CODIGO <input name="COD" type="text" class="celdas01" value="" size="10" maxlength="5"/>
			...
			<td>
				...
				<input type="hidden" name="opt" value="32"/>
			</td>
			...
			<td>
				<table width="100%" border="1" align="center" cellspacing="0" bordercolor="#DFE6EE" bgcolor="#FFFFFF">
					<tr bgcolor="#3DB7E4" class="Estilo3" align="center">
					  <td >ITEM</td>
					  <td>CODIGO UNIDADES ORGANICAS NIVEL 01</td>
					  <td>UNIDADES ORGANICAS NIVEL 01</td>
					  <td >ESTADO</td>
					</tr>
	...
	%>
              ...
              <a href="javascript:getReg('<%=StringUtils.defaultString(String.valueOf(v.get(0)))%>','<%=StringUtils.defaultString(String.valueOf(v.get(1)))%>','<%=StringUtils.defaultString(String.valueOf(v.get(2)))%>');">
            ...
            &nbsp;&nbsp; <%= counter + ((Integer.parseInt(objLst.getPag()) - 1)  * 15) %></td>
            			<td align="center"><%= StringUtils.defaultString(String.valueOf(v.get(0)))%></td> 
			...
			<td>
				<table width="100%" border="1" align="center"  cellspacing="0" bordercolor="#DFE6EE" bgcolor="#FFFFFF">
					<tr class="Estilo3"  bgcolor="#3DB7E4" align="center">
					  <td colspan="2"><center>NUEVA UNIDAD ORGANICA NIVEL 01</center></td>
					...
					<tr align="center">
					  <td><input name="CODIGO" type="text" class="celdas01" onfocus="nextfield ='DESCRIPCION';" size="10" maxlength="20"/></td>
						<td><input name="DESCRIPCION" type="text" class="celdas01" onchange="cambia(this);" size="100" maxlength="100" /></td>
						<td>
					...
					<tr align="center">
						<td colspan="3" bgcolor="#3DB7E4">
							<input type="hidden" name="pg" value="<%= objLst.getPag()%>"/>
							<input type="hidden" name="opt" value="33"/>
