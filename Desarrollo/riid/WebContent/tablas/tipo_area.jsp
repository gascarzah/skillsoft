...
function getReg(cod,des,est){
	//document.f.CODACCION.value = tem;
...
<table width="100%" align="center">
  ...
  <tr>
    <td colspan="3" align="center" class="titulo1"><%=Constantes.TITULO_MANTENIMIENTO_TABLA_AREA %></td>
  </tr>
</table>
<form name="f1" method="post">
	<table width="700" border="0" align="center" cellspacing="0">
		<tr>
				...
				<td><%= Constantes.TIPO_AREA %><b>*</b>
               
                <input name="COD" type="text" class="celdas01" onfocus="nextfield ='DES';" size="2" maxlength="2"></td>
            <td>
		...
		<tr>
			<td>
				<table width="100%" border="1" align="center"  cellspacing="0" bordercolor="#DFE6EE" bgcolor="#FFFFFF">
					...
					<tr align="center">
						<td>
               <input name="CODACCION" class="celdas01" onfocus="nextfield ='DESACCION';" type="text">
                </td>
						
						<td><input name="DESACCION" type="text" class="celdas01" onfocus="nextfield ='BESTADOREG';" onchange="cambia(this);" size="50" maxlength="60"></td>
						<td>
