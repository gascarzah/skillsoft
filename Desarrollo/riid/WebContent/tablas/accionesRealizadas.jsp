...
<table width="100%" align="center">
  ...
  <tr>
    <td colspan="3" align="center" class="titulo1">MANTENIMIENTO DE LA TABLA ACCIONES REALIZADAS</td>
  </tr>
</table>
		...
		<tr>
			<td>
				<table width="100%" border="1" align="center"  cellspacing="0" bordercolor="#DFE6EE" bgcolor="#FFFFFF">
					...
					<tr align="center">
						<td><input name="CODACCION" type="text" class="celdas01" onfocus="nextfield ='DESACCION';" onchange="veridigitos(this);" size="11" maxlength="11"/></td>
