...
//stm_aix("p1i1","p0i0",[0,"EXPEDIENTES ESSALUD EN LINEA","","",-1,-1,0,"CtrlFicha?opt=19","_self","","","","",0,0,0,"","",0,0,0,0,1,"#3DB7E4",0,"#ffffff",0,"","",3,3,1,2,"#3DB7E4","#ffffff","#ffffff","#3DB7E4","8pt 'Tahoma','Arial'","8pt 'Tahoma','Arial'"]);
//stm_aix("p3i4","p1i0",[0,"BUSQUEDA DE EXPEDIENTE","","",-1,-1,0,"CtrlFicha?opt=3"]);
stm_aix("p1i1","p0i0",[0,"BUSQUEDA DE EXPEDIENTE","","",-1,-1,0,"CtrlFicha?opt=3"]);
