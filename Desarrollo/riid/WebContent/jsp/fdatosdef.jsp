...
function grabar(){
	...
	//}
		...
		alert("Campo Gestión no puede estar vacio");
		event.returnValue=false;
...
<br />
        ...
        <td valign="top" nowrap ="nowrap" width="150px"><%= Constantes.GESTION %><b>*</b></td>
          ...
          <td valign="top" nowrap ="nowrap"  width="150px"><%= Constantes.DOC_RELAC %></td>
            <td id="resetf" valign="top"><input type="file" name="FICHERO" id="FICHERO" onchange="revisar_pdf();" /><br />&nbsp;Archivo PDF o JPG, tamaño max. 1MB.
           <br/>
