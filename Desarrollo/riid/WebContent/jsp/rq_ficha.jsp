...
<table width="70%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td align="center" class="titulo1"><%=Constantes.SUBTITULO_BUSQUEDA_DE_EXPEDIENTE %></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#6699CC" bgcolor="#FFFFFF">
        <tr>
          <td scope="col"><table width="100%" class="celdas01">
            ...
            <tr>
              <td>&nbsp;</td>
              <td style="text-transform: uppercase;"><%= Constantes.UNIDADORG1 %> </td>
            ...
            <tr>
              ...
              <td colspan="2">A&ntilde;o:
                ...
                &nbsp;&nbsp;Cas:
<input name="CAS" type="text" onkeypress="return soloNumeros(event)" class="celdas01" value="<%=(String)request.getParameter("CAS")==null?"":request.getParameter("CAS")%>" onfocus="nextfield ='CORREL';" size="10" maxlength="10" />
&nbsp;&nbsp;Correlativo:
<input name="CORREL" type="text" onkeypress="return soloNumeros(event)" class="celdas01" value="<%=(String)request.getParameter("CORREL")==null?"":request.getParameter("CORREL")%>" onfocus="nextfield ='DFICDID';" size="10" maxlength="10" onchange="veridigitos(this);" /></td>
            </tr>
            <tr>
              <td colspan="4">&nbsp;</td>
              </tr>
          ...
          <%
                ...
                <input name="DFICDID" type="text" onkeypress="return soloNumeros(event)" class="celdas01" value="<%=(String)request.getParameter("DFICDID")==null?"":request.getParameter("DFICDID")%>" onfocus="nextfield ='DAPEPAT';" size="10" maxlength="10" onchange="veridigitos(this);" /></td>
              <td>&nbsp;</td>
              </tr>
            <tr>
              <td colspan="4">&nbsp;</td>
            ...
            <tr>
              ...
              <td colspan="2">
			  AP:
			  <input name="DAPEPAT" onkeypress="return soloLetras(event)" type="text" class="celdas01" value="<%=(String)request.getParameter("DAPEPAT")==null?"":request.getParameter("DAPEPAT")%>" size="20" onfocus="nextfield ='DAPEMAT';" onchange="cambia(this);" maxlength="20">
               AM: <input name="DAPEMAT" onkeypress="return soloLetras(event)" type="text" class="celdas01" value="<%=(String)request.getParameter("DAPEMAT")==null?"":request.getParameter("DAPEMAT")%>" size="20" onfocus="nextfield ='DNOM';" onchange="cambia(this);" maxlength="20" />
               Nomb: <input name="DNOM" onkeypress="return soloLetras(event)" type="text" class="celdas01" value="<%=(String)request.getParameter("DNOM")==null?"":request.getParameter("DNOM")%>" size="20" onfocus="nextfield ='DAPEPATREC';" onchange="cambia(this);" maxlength="20" /></td>
              </tr>
            <tr>
              <td colspan="4">&nbsp;</td>
            </tr>
            <tr>
              ...
              <td colspan="2">AP:
                <input name="DAPEPATREC" onkeypress="return soloLetras(event)" type="text" class="celdas01" value="<%=(String)request.getParameter("DAPEPATREC")==null?"":request.getParameter("DAPEPATREC")%>" size="20" onfocus="nextfield ='DAPEMATREC';" onchange="cambia(this);" maxlength="20" />
AM:
<input name="DAPEMATREC" type="text" onkeypress="return soloLetras(event)" class="celdas01" value="<%=(String)request.getParameter("DAPEMATREC")==null?"":request.getParameter("DAPEMATREC")%>" size="20" onfocus="nextfield ='DNOMREC';" onchange="cambia(this);" maxlength="20" />
Nomb:
<input name="DNOMREC" type="text" onkeypress="return soloLetras(event)" class="celdas01" value="<%=(String)request.getParameter("DNOMREC")==null?"":request.getParameter("DNOMREC")%>" size="20" onfocus="nextfield ='FECHA1';" onchange="cambia(this);" maxlength="20" /></td>
              </tr>
            <tr>
              <td colspan="4">&nbsp;</td>
            </tr>
            <tr>
              ...
              <td>De: <input name="FECHA1" id="sel1" type="text" class="celdas01" size="10"  maxlength="10" readonly="readonly"><input type="reset" value=" ... " onclick="return showCalendar('sel1', '%d/%m/%Y');"></td>
              <td>Hasta: <input name="FECHA2" id="sel2" type="text" class="celdas01" size="10"  maxlength="10"  readonly="readonly"><input type="reset" value=" ... " onclick="return showCalendar('sel2', '%d/%m/%Y');"></td>
            </tr>
            <tr>
              <td colspan="4">&nbsp;</td>
            </tr>
   ...
   <tr>
     <td>
         ...
         <tr bgcolor="#B0C4DE" class="celdas01" align="center"> 
           ...
           <td bgcolor="#3DB7E4" class="Estilo3">TITULAR</td>
...
%>
            ...
            <td><%= v.get(7)!=null?v.get(7):"&nbsp;" %>&nbsp;<%= v.get(8)!=null?v.get(8):"&nbsp;" %>,<%= v.get(9)!=null?v.get(9):"&nbsp;" %></td>
            <td align="left"><%= v.get(4)!=null?v.get(4):"" %>&nbsp;<%= v.get(5)!=null?v.get(5):"" %>,<%= v.get(6)!=null?v.get(6):"" %></td>
